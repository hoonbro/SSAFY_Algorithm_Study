# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/11.svg" width="30"> [10026] 적록색약
...
## 문제 풀이
1. bfs알고리즘을 돌리며 red, green, blue 지역의 수를 각각 세어둔다.
1. 또 다른 bfs 알고리즘을 돌리며 적록(red, green) 지역의 수를 세어둔다.
1. red+gree+blue 와 red, green + blue를 각각 출력한다.
